import sqlite_vss
import sqlite3
from insert.InsertEmbeddingsToDB import insert_embeddings_to_db
...
cur.executescript("""
    CREATE VIRTUAL TABLE IF NOT EXISTS hadith_faiss USING vss0(embeddings(768));
...
for line in lines:
    ...
    insert_embeddings_to_db(cur, line.strip())
    conn.commit()
